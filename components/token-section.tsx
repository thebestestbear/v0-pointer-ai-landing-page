        ...
        <div className="self-stretch flex flex-col justify-center items-center gap-12 z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
            <Button size="lg" className="gap-2 bg-[#14F195] text-black hover:bg-[#14F195]/90" asChild>
              <a href="https://pump.fun/coin/CAADDY" target="_blank" rel="noopener noreferrer">
            ...
            <Button variant="outline" size="lg" className="gap-2 bg-transparent" asChild>
              <a href="https://solscan.io/token/CAADDY" target="_blank" rel="noopener noreferrer">
                View on Solscan
              </a>
            </Button>
          </div>
